...
do
    ...
    services.InputService.InputChanged:Connect(
        function(input, gpe)
            for obj, signals in next, objsignals do
                if objexists[obj] and obj.Visible and
                            ...
                            if amount > 0 then
                                ...
                                for i, object in next, objchildren[self] do
                                    ...
                                    object.Position = object.Position +
                                        Vector2.new(0, poschange - diff + objpaddings[self])
                                end
                            else
                                local poschange = currentclippedobj.Size.Y + objpaddings[self]
            ...
            { exists = true },
            {
                    ...
                    if k == "Remove" then
                        return function(self)
                            ...
                            if customproperties.Parent and listobjs[customproperties.Parent] then
                                ...
                                listcontents[customproperties.Parent] = listcontents[customproperties.Parent] -
                                    listadds[customproperties.Parent][obj]

                                for i, object in next, objchildren[customproperties.Parent] do
                                    if i > objindex then
                                        object.Position = object.Position -
                                            Vector2.new(0, listadds[customproperties.Parent][obj])
                                    end
                                end
                ...
                __newindex = function(self, k, v)
                    ...
                    changechildrenvis = function(parent, vis)
                        if objchildren[parent] then
                            for _, object in next, objchildren[parent] do
                                if (custompropertygets[ mtobjs[parent] ]("ClipsDescendants") and
                                    not istouching(
                                        object.Position,
                                        object.Size,
                    ...
                    if k == "Visible" then
                        ...
                        if customproperties.Parent and
                        ...
                        if typeof(v) == "UDim2" then
                            ...
                            if customproperties.Parent then
                                ...
                                if listobjs[customproperties.Parent] then
                                    ...
                                    v = mtobjs[customproperties.Parent].Position +
                    ...
                    if k == "Size" then
                        if typeof(v) == "UDim2" then
                            ...
                            if customproperties.Parent and listobjs[customproperties.Parent] then
                                ...
                                listadds[customproperties.Parent][obj] = listadds[customproperties.Parent][obj] +
                                    sizediff

                                for i, object in next, objchildren[customproperties.Parent] do
                                    if i > objindex then
                                        object.Position = object.Position + Vector2.new(0, sizediff)
                                        listindexes[customproperties.Parent][i] = listindexes[customproperties.Parent][i
                                            ] + sizediff
                                    end
                                end
                            end
                            ...
                            if customproperties.ClipsDescendants then
                                for _, object in next, objchildren[self] do
                                    object.Visible = istouching(object.Position, object.Size, obj.Position, v) and
                                        objvisibles[object] or
                                        false
                                end
                            end
                    ...
                    if k == "Parent" then
                        ...
                        if udim2sizeobjs[obj] then
                            ...
                            if custompropertygets[ mtobjs[v] ]("ClipsDescendants") then
                                obj.Visible = istouching(obj.Position, newsize, mtobjs[v].Position, mtobjs[v].Size) and
                                    objvisibles[obj] or
                                    false
                            end
                        ...
                        if listobjs[v] then
                            ...
                            listcontents[v] = listcontents[v] + obj.Size.Y +
                        ...
                        if udim2posobjs[obj] then
                            ...
                            if custompropertygets[ mtobjs[v] ]("ClipsDescendants") then
                                obj.Visible = istouching(newpos, obj.Size, mtobjs[v].Position, mtobjs[v].Size) and
                                    objvisibles[obj] or
                                    false
                            end
                        ...
                        if custompropertygets[ mtobjs[v] ]("ClipsDescendants") then
                            obj.Visible = istouching(obj.Position, obj.Size, mtobjs[v].Position, mtobjs[v].Size) and
                                objvisibles[obj] or
                                false
                        end
...
local themes = {
    Default = {
        ...
        ["Text"] = Color3.fromRGB(169, 169, 169),
    ...
    box.MouseButton1Click:Connect(
        function()
            ...
            if not connection then
                        ...
                        if input.UserInputType == Enum.UserInputType.Keyboard then
                            if input.KeyCode ~= Enum.KeyCode.Backspace then
                                ...
                                if table.find(allowedcharacters, str) then
                                    ...
                                    if not services.InputService:IsKeyDown(Enum.KeyCode.RightShift) and
                ...
                backspaceconnection = utility.connect(
                    services.InputService.InputBegan,
                    function(input)
...
function library.createdropdown(
    ...
    dropdown.MouseButton1Up:Connect(
        function()
            dropdown.Color = mouseover and utility.changecolor(library.theme["Object Background"], 3) or
                ...
                if max then
                    if table.find(chosen, option) then
                        ...
                        for _, opt in next, chosen do
                            ...
                            if utility.textlength(table.concat(textchosen, ", ") .. ", ...", Drawing.Fonts.Plex, 13).X >
                        ...
                        value.Text = #chosen == 0 and "NONE" or
...
function library.createslider(min, max, parent, text, default, float, flag, callback)
    ...
    utility.connect(
        ...
        function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 then
                sliding = false
                slider.Color = mouseover and utility.changecolor(library.theme["Object Background"], 3) or
                    library.theme["Object Background"]
            end
        end
    )
...
function library.createcolorpicker(default, defaultalpha, parent, count, flag, callback)
    ...
    rgbinput.MouseButton1Up:Connect(
        function()
            rgbinput.Color = mouseover and utility.changecolor(library.theme["Object Background"], 3) or
                library.theme["Object Background"]
        end
    )
    ...
    local function set(color, a, nopos)
        ...
        if hsv ~= oldcolor or alpha ~= oldalpha then
            ...
            if not nopos then
                ...
                huepicker.Position = UDim2.new(0,
                    math.clamp(hue * hueframe.AbsoluteSize.X, 0, hueframe.AbsoluteSize.X - 2), 0, 0)
            ...
            text.Text = string.format("%s, %s, %s", math.round(hsv.R * 255), math.round(hsv.G * 255),
...
function library.createkeybind(default, parent, blacklist, flag, callback, offset)
    ...
    utility.connect(
        services.InputService.InputBegan,
        function(input)
            if not binding and (input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode == key) or
...
function library:Load(options)
    ...
    function windowtypes:Tab(name)
        ...
        tabtoggle.MouseEnter:Connect(
            function()
                mouseover = true
                tabtoggle.Color = tab.Visible == true and utility.changecolor(library.theme["Tab Toggle Background"], 3)
                    or
        ...
        tabtoggle.MouseLeave:Connect(
            function()
                mouseover = false
                tabtoggle.Color = tab.Visible == true and library.theme["Tab Toggle Background"] or
                    library.theme["Tab Background"]
            end
        )

        tabtoggle.MouseButton1Down:Connect(
            function()
                tabtoggle.Color = tab.Visible == true and utility.changecolor(library.theme["Tab Toggle Background"], 6)
                    or
        ...
        tabtoggle.MouseButton1Click:Connect(
            function()
                ...
                tabtoggle.Color = mouseover and utility.changecolor(library.theme["Tab Toggle Background"], 3) or
                    utility.changecolor(library.theme["Tab Background"], 3)
        ...
        function tabtypes:Section(options)
            ...
            function sectiontypes:Button(options)
                ...
                button.MouseButton1Up:Connect(
                    function()
                        button.Color = mouseover and utility.changecolor(library.theme["Object Background"], 3) or
                            library.theme["Object Background"]
                    end
                )
            ...
            function sectiontypes:Toggle(options)
                ...
                icon.MouseButton1Up:Connect(
                    function()
                        if not toggled then
                            icon.Color = mouseover and utility.changecolor(library.theme["Object Background"], 3) or
                                library.theme["Object Background"]
                        end
                    end
                )
                ...
                local function setstate()
                    ...
                    icon.Color = toggled and library.theme["Accent"] or
            ...
            function sectiontypes:Box(options)
                ...
                box.MouseButton1Up:Connect(
                    function()
                        box.Color = mouseover and utility.changecolor(library.theme["Object Background"], 3) or
                            library.theme["Object Background"]
                    end
                )
